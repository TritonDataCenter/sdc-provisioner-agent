...
var whenZoneStatusChange =
module.exports.whenZoneStatusChange =
function (zone, targetStatus, callback) {
    var repeater = setInterval(function () {
        zoneList('', function (err, list) {
            if (list[zone] !== undefined && list[zone].state === targetStatus) {
