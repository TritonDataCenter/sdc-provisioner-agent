...
function extend (base, overlay) {
  ...
  props.forEach(function(name) {
    obj[name] = base[name] ? base[name] : overlay[name];
  });
  return obj;
}
...
// machines waiting to be zoneinit'd. We'll keep track of the number of
...
ProvisionerAgent.prototype.handleProvision = function (msg) {
  ...
  function shouldShift() {
    ...
    console.log("Shifting should be " + shift);
    return shift;
  }
