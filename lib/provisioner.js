...
exports.ProvisionerAgent = ProvisionerAgent = function (config) {
  ...
  this.initializeHVMCommands();

  if (os.type() == 'Linux') {
    this.vmadm = VMADMClient.connect('/tmp/vmadmd_sock', function() {
...
ProvisionerAgent.prototype.hvm_boot = function(msg) {
  ...
  vmadm.action('boot', { uuid: msg.data.uuid }, function(result) {
    console.log(result);
  });
}
...
ProvisionerAgent.prototype.hvm_reset = function(msg) {
  ...
  vmadm.action('reset', { uuid: msg.data.uuid }, function(result) {
    console.log(result);
  });
}
...
ProvisionerAgent.prototype.hvm_halt = function(msg) {
  ...
  vmadm.action('halt', { uuid: msg.data.uuid }, function(result) {
    console.log(result);
  });
}
